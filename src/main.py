...
database_entry = tk.Entry(window, width=30)
database_entry.pack(pady=10, anchor='w', padx=10)

select_button = tk.Button(window, text="Выбрать базу данных", command=lambda: select_database_file(
    database_entry, table_tree, selected_tables))
select_button.pack(pady=5, anchor='w', padx=20)
